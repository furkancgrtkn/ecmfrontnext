        ...
        <div className={styles.gridWrapper}>
            <div className={styles.parent}>
                <div className={styles.div1}>
                    <Image unoptimized={true} layout='fill' alt="homepagegrid1" src="https://res.cloudinary.com/dhy7yh4aa/image/upload/v1618597361/pexels-monicore-1391487_lt5zb9.jpg" />
