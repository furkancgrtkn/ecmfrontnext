...
export default function Navbar() {
    ...
    return (
        <nav className={styles.navbarContainer}>
            <div className={styles.navbarTopSide}>
                <div className={styles.navbarTopInner}>
                    <ul className={styles.navbarTopLeft}>
                        <li>
                            <span style={{ marginRight: 7 }}>EN</span> <Image unoptimized={true} src="/arrowdown.svg" alt="arrow" width="12" height="6,86" />
                        </li>
                        <Image unoptimized={true} src="/stick.svg" alt="arrow" width="1" height="35" />
                        <li>
                            <Link href="/sepetim">
                                <a>SHOP</a>
                            </Link>
            ...
            <div className={styles.navbarCenter}>
                <div className={styles.navbarCenterTop}>
                    ...
                    <div className={styles.navbarSearch}>
                        <Image unoptimized={true} src="/search.svg" alt="arrow" width="23" height="23" />
                    ...
                    <div className={styles.navbarCenterLinks}>
                        <Link href="/bize-katil">
                            <a><Image unoptimized={true} src="/usericon.svg" alt="arrow" width="21,6" height="23" /></a>
                        </Link>
                        <Link href="/hesap">
                            <a><Image unoptimized={true} src="/hearticon.svg" alt="arrow" width="25,91" height="23" /></a>
                        </Link>
                        <Popup
                            flowing
                            on='click'
                            ...
                            trigger={<div className={styles.navbarCenterLinksBask}>
                                <span className={styles.basketCount}>2</span><Image unoptimized={true} src="/basketicon.svg" alt="arrow" width="25,49" height="23" />
                            </div>}>
                            <div className={styles.navbarBasketContainer}>
                                <strong className={styles.navbarBasketContainerHead}>Sepetim <span>/ 2 Ürün</span></strong>
                                <div className={styles.navbarBasketItems}>
                                    <div className={styles.navbarBasketItemImage}>
                                        <Image unoptimized={true} width={70} height={70} src="https://i.hizliresim.com/pxJJ4z.png" />
                                    </div>
                                    ...
                                    <div className={styles.navbarBasketItemDel}>
                                        <Image unoptimized={true} layout='fill' src="/deleteBasItem.svg" />
                                    </div>
                                </div>
                                <div className={styles.navbarBasketItems}>
                                    <div className={styles.navbarBasketItemImage}>
                                ...
                                <div className={styles.navbarBasketShipCon}>
                                    ...
                                    <Link href='/sepetim'>
                                        <a>
                                            <button className={styles.navbarBasketBuyBtn}>SATIN AL</button>
                                        </a>
                                    </Link>
                                    <button className={styles.navbarBasketCloseBtn}>Alışverişe devam et</button>
                                </div>
                            </div>
                        </Popup>
                        <div onClick={() => setHamMenuOpen(!hamMenuOpen)} className={styles.hamIcon}>
                ...
                <div className={styles.navbarBottomSideInner}>
                    <ul>
                        ...
                        <Popup
                            ...
                            trigger={
                                <li>
                                    <Link href="/organik-gida"><a>TAKI</a></Link>
                                </li>
                            }>
            ...
            <div className={hamMenuOpen ? styles.hamMenuInnerContainer : `${styles.hamMenuInnerContainer} ${styles.hamMenuInnerContainerClose}`}>
