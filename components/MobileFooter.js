                    ...
                    <div className={styles.footerArticlesAccordion}>
                        {accordion ?
                            <h3 onClick={() => setAccordion(!accordion)} className={styles.footerHeadersMobile}>
                                ...
                                <Image src="/arrowdownWhite.svg" alt="arrow" width="9" height="9" />
                            </h3>
                            :
                            <h3 onClick={() => setAccordion(!accordion)} className={styles.footerHeadersMobile}>
                                MÜŞTERİ HİZMETLERİ
                                <Image unoptimized={true} src="/nextIconWhite.svg" alt="arrow" width="5" height="9" />
                            </h3>}
                    ...
                    <div>
                        {accordion2 ?
                            <h3 onClick={() => setAccordion2(!accordion2)} className={styles.footerHeadersMobile}>
                                <b>HAKKIMIZDA</b>
                                <Image unoptimized={true} src="/arrowdownWhite.svg" alt="arrow" width="9" height="9" />
                            </h3>
                            :
                            <h3 onClick={() => setAccordion2(!accordion2)} className={styles.footerHeadersMobile}>
                                HAKKIMIZDA
