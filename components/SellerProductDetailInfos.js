                        ...
                        <SwiperSlide>
                            <div className={styles.sellerProductCategorySlide}>
                                <label className={styles.searchLabel}>
                                    ...
                                    <Image unoptimized={true} src="/searchIconMini.svg" alt="arrow" width="9" height="9" />
                                </label>
            ...
            <form className={styles.sellerProductDetailInfosForm}>
                ...
                <div className={styles.SellerProductDetailInfosBtns}>
                    <button
                        ...
                        className={styles.prevBtn}><Image unoptimized={true} src="/prevIcon.svg" alt="timer" width="5" height="9" /><p>GERİ DÖN</p></button>
                    <button
