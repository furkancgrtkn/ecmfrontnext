            ...
            {orderDetail === false ?
                <>
                    ...
                    <div className={styles.orderWrapper} onClick={() => setOrderDetail(true)}>
                        ...
                        <div className={styles.orderRight}>
                            ...
                            <Image unoptimized={true} src="/nextIcon.svg" alt="next" width="5" height="8.5" />
                        </div>
                    </div>
                </>
                :
                ...
                <div className={styles.orderDetailWrapper}>
                    <p className={styles.subTitle}>
                        <Image unoptimized={true} src="/infoIcon.svg" alt="next" width="20" height="20" />
                    ...
                    <div className={styles.orderSummaryWrappper}>
                        ...
                        <div className={styles.orderSummaryBottom}>
                            <div className={styles.orderSummaryTexts}>
                                <b>Ödeme Bilgileri</b>
                                <p >
                                    <Image unoptimized={true} className={styles.orderSummaryCardImg} src="/orderCard.svg" alt="mastercard" width="20" height="15" />
                                    ****8674 / Tek Çekim
                                </p>
                            </div>
                            <div className={styles.orderSummaryTexts}>
