                    ...
                    {tabName === 'Desc' ?
                        ...
                        <div className={styles.productTabsShip}>
                            <div className={styles.productTabsShipImage}>
                                <div>
                                    <Image unoptimized={true} layout='fill' src="/cargo.svg" />
                                </div>
                            ...
                            <div className={styles.productTabsShipImage}>
                                <div>
                                    <Image unoptimized={true} layout='fill' src="/cardgree.svg" />
                                </div>
                                <p>Ödeme Metodları</p>
                            </div>
                    ...
                    <div key={index} className={styles.comment}>
                        <div className={styles.commentInfo}>
                            ...
                            <div className={styles.commentFav}>
                                ...
                                <button>
                                    <Image unoptimized={true} src="/hearticon.svg" alt="arrow" width={10} height={10} />
                                    <span>1</span>
                                </button>
                            </div>
                        </div>
