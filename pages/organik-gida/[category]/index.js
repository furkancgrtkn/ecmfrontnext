    ...
    return (
        <Layout>
            ...
            <div className={styles.headerBannerProduct}>
                <Image unoptimized={true} layout='fill' src='https://i.hizliresim.com/Wr0lKb.png' />
                ...
                <div className={styles.prodBottomContainer}>
                    ...
                    <div className={styles.productsContainer}>
                        {productsState.map((productState, index) => (
                            <ProductCard customSlideIndex={setSlideIndex} modalOpen={setModalOpen} indexNo={index} key={index} productInfos={productState} />
                        ))}
                        <p className={styles.counterDetail}>30 üründen 12 tanesi gösteriliyor.</p>
