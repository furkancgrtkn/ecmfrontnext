        ...
        <Layout>
            ...
            <main className={styles.contactMain}>
                <div className={styles.contactConUs}>
                    ...
                    <span className={styles.contactConUsSpan}>Yardıma mı ihtiyacınız var?</span>
                    ...
                    <div className={styles.contactForm}>
                        <form>
                            ...
                            <div className={styles.contactFormIL}>
                                ...
                                <Dropdown defaultValue={1} className="contactDropdown" options={options} selection />
                            </div>
                            <div className={styles.contactFormIL}>
                                <label>Mesaj</label>
                                <textarea></textarea>
            ...
            <div className={styles.customerSupport}>
                {openCustServ ?
                    <div className={styles.customerSupportChat}>
                        <h6 onClick={() => setOpenCustServ(!openCustServ)}>Canlı Destek <span>-</span></h6>
                        <div className={styles.customerSupportChatForm}>
                            <p style={{ fontSize: '13px' }}>Sohbet etmeyi çok isteriz! Haftanın 7 günü, 09:00 - 19:00 buradayız. Mesaj bırakın, tekrar çevrimiçi olduğumuzda sizinle iletişime geçelim.</p>
                            <form>
                                <div className={styles.contactFormIL}>
                                    <label>* İsim, Soyisim</label>
                                    <input></input>
                    ...
                    :
                    <div onClick={() => setOpenCustServ(!openCustServ)} className={styles.customerSupportJoin}>
                        <i className="far fa-comment-alt"></i> <span>Canlı Destek - Kapalı</span>
                    </div>
                }
            </div>
        </Layout>
